 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Atom");
		  toPrint += p2.toString("902700936");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Wisdom");
		  toPrint += p3.toString("902748783");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Jamie");
          toPrint += p4.toString("902593247");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Eric");
          toPrint += p5.toString("902686207");
